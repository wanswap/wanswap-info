...
function AccountPage({ account }) {
  ...
  const miningPositions = undefined
      ...
      <ContentWrapper>
        <RowBetween>
          <TYPE.body>
            ...
            <Link lineHeight={'145.23%'} href={'https://www.wanscan.org/address/' + account} target="_blank">
              {' '}
              {account?.slice(0, 42)}{' '}
            </Link>
          </TYPE.body>
        ...
        <Header>
          <RowBetween>
            <span>
              ...
              <Link lineHeight={'145.23%'} href={'https://www.wanscan.org/address/' + account} target="_blank">
                <TYPE.main fontSize={14}>View on Wanscan</TYPE.main>
              </Link>
            </span>
            <AccountWrapper>
              <StyledIcon>
